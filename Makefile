...
BIN := dc1394-camls dc1394-show dc1394-view dc1394-record dc1394-record-bracketing dc1394-play
...
dc1394-record-bracketing: record-bracketing.o utils.o gtkutils.o
	$(CC) $(LDFLAGS) -o $@ $^ $(LIBS)
